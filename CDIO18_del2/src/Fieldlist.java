...
public  class  Fieldlist 
{
	...
	public Fieldlist()
	{
		...
		fields[1] = new Street.Builder().setTitle("Tower").setDescription("You have found a mysterious tower and chest lays inside, you've gained 250 gold").setRent("250,-").build();
...
//		fieldList[3] = new Field(-20, "Cold desert", "You've found yourself in a very cold dersert, you are freezing and must get a cup of coffe, you've paid 20 gold");
...
//		fieldList[5] = new Field(0, "Monastery", "You appears to be at the monastery, nothing really happens here, nothing happened");
...
//		fieldList[8] = new Field(-80, "The Werewall", "You have encountered a wall of wolves, you run for your life on the fly, some gold pops out for your pocket, you lost 80 gold");
